/**
 * IDV Modal Launcher (ryan-offset)
 *
...
const logger = ((window as any).G7Core?.createLogger?.('Template:ryan-offset:IdentityLauncher')) ?? {
  log: (...args: unknown[]) => console.log('[Template:ryan-offset:IdentityLauncher]', ...args),
  warn: (...args: unknown[]) => console.warn('[Template:ryan-offset:IdentityLauncher]', ...args),
  error: (...args: unknown[]) => console.error('[Template:ryan-offset:IdentityLauncher]', ...args),
};
 ...
 */
export function registerRyanOffsetIdentityLauncher(): void {
  ...
  logger.log('IDV launcher registered (ryan-offset)');
}
