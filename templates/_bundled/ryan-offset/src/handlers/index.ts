...
export const handlers = {
  // 상품 옵션
  'ryan-offset.addSelectedItemIfComplete': addSelectedItemIfCompleteHandler,
  'ryan-offset.updateSelectedItemQuantity': updateSelectedItemQuantityHandler,

  // 다중 통화
  'ryan-offset.getDisplayPrice': getDisplayPriceHandler,
  'ryan-offset.formatCurrency': formatCurrencyHandler,
  'ryan-offset.getCurrencySymbol': getCurrencySymbol,
  'ryan-offset.loadPreferredCurrency': loadPreferredCurrencyHandler,
  'ryan-offset.savePreferredCurrency': savePreferredCurrencyHandler,
