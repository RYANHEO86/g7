...
describe('admin install modals — vendor_mode Select 필드', () => {
  describe('모듈 설치 모달 (_modal_install.json)', () => {
    const layout = loadLayout(
      'templates/_bundled/offset-admin/layouts/partials/admin_module_list/_modal_install.json'
    );
  ...
  describe('플러그인 설치 모달 (_modal_install.json)', () => {
    const layout = loadLayout(
      'templates/_bundled/offset-admin/layouts/partials/admin_plugin_list/_modal_install.json'
    );
