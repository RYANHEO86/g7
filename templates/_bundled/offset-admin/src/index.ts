...
const logger = ((window as any).G7Core?.createLogger?.('Template:offset-admin')) ?? {
    log: (...args: unknown[]) => console.log('[Template:offset-admin]', ...args),
    warn: (...args: unknown[]) => console.warn('[Template:offset-admin]', ...args),
    error: (...args: unknown[]) => console.error('[Template:offset-admin]', ...args),
};
